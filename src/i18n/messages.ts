...
export const messages = {
  zh: {
    ...
    integrateCake: {
      ...
      integrateFiber: {
        ...
        xAxisPlaceholder: '留空则用单位推导',
        yAxisPlaceholder: '留空则用单位推导',
        rangeSection: '积分范围',
    ...
    poniImporter: {
      ...
      // —— 新增（v0.2.3）：导入参考图像 + 自动探测器匹配 / 折叠区 / 光斑起始点 ——
  ...
  en: {
    ...
    integrateFiber: {
      ...
      xAxisPlaceholder: 'Empty = unit-derived',
      yAxisPlaceholder: 'Empty = unit-derived',
    ...
    poniImporter: {
      ...
      // —— New (v0.2.3): reference-image import + auto detector match / collapsibles / beam-center origin ——
